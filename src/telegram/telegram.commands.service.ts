...
export class TelegramCommandsService {
  ...
  private isUnderConstruction: boolean = process.env.IS_UNDER_CONSTRUCTION === 'true';
  ...
  private async handleUserEvent(
    ...
    const isAwaitingSupportMessage = (ctx as AppContext).session.awaitingSupportMessage;
